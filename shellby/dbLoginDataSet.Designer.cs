...
namespace shellby {
    ...
    public partial class dbLoginDataSet : global::System.Data.DataSet {
        ...
        public partial class LoginDataTable : global::System.Data.TypedTableBase<LoginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LoginRow AddLoginRow(string kullanici, string sifre) {
        ...
        public partial class LoginRow : global::System.Data.DataRow {
            ...
            public string kullanici {
                get {
                    try {
                        return ((string)(this[this.tableLogin.kullaniciColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("\'Login\' tablosundaki \'kullanici\' sütunun değeri DBNull.", e);
                    }
                }
                set {
                    this[this.tableLogin.kullaniciColumn] = value;
                }
            }
            ...
            public bool IskullaniciNull() {
                return this.IsNull(this.tableLogin.kullaniciColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetkullaniciNull() {
                this[this.tableLogin.kullaniciColumn] = global::System.Convert.DBNull;
            }
...
namespace shellby.dbLoginDataSetTableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Login` WHERE ((`ID` = ?) AND ((? = 1 AND `kullanici` IS NULL) OR (`k" +
                "ullanici` = ?)) AND ((? = 1 AND `sifre` IS NULL) OR (`sifre` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Login` (`kullanici`, `sifre`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Login` SET `kullanici` = ?, `sifre` = ? WHERE ((`ID` = ?) AND ((? = 1 AND" +
                " `kullanici` IS NULL) OR (`kullanici` = ?)) AND ((? = 1 AND `sifre` IS NULL) OR " +
                "(`sifre` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::shellby.Properties.Settings.Default.dbLoginConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, kullanici, sifre FROM Login";
        ...
        public virtual int Fill(dbLoginDataSet.LoginDataTable dataTable) {
        ...
        public virtual dbLoginDataSet.LoginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbLoginDataSet.LoginDataTable dataTable = new dbLoginDataSet.LoginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbLoginDataSet.LoginDataTable dataTable) {
